...
be careful: more types of motion are possible than before, so you might want to
...
if __name__ == "__main__":
  ...
  while line:
    ...
    for i in range(int(line[1])):
      r_pos[0] = [r_pos[0][0] + h_move[0], r_pos[0][1] + h_move[1]]
      for t in range(1, 10):
        t_move = [r_pos[t - 1][0] - r_pos[t][0], r_pos[t - 1][1] - r_pos[t][1]]
        
        if(abs(t_move[0]) == 2 or abs(t_move[1]) == 2):
          t_move[0] = 1 if t_move[0] == 2 else t_move[0]
          t_move[0] = -1 if t_move[0] == -2 else t_move[0]
          t_move[1] = 1 if t_move[1] == 2 else t_move[1]
          t_move[1] = -1 if t_move[1] == -2 else t_move[1]        
          r_pos[t] = [r_pos[t][0] + t_move[0], r_pos[t][1] + t_move[1]]
      visited_positions.add(tuple(r_pos[9]))
    
    
    line = inputFile.readline()
  inputFile.close()

  print(f"The tail visited {len(visited_positions)} unique positions")