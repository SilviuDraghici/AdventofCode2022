...
if __name__ == "__main__":
  print("Checking rucksacks for misplaced items...")
  ...
  while line:
    ...
    dup_val = ord(item) - 97 + 1 if ord(item) >= 97 else ord(item) - 65 + 27
    duplicate_priority_sum += dup_val
    
    line = inputFile.readline()
  inputFile.close()

  print("The duplicate priority is {}!".format(duplicate_priority_sum))