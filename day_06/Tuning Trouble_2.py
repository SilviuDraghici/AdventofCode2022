...
if __name__ == "__main__":
  ...
  while line:
    ...
    for index in range(consec_distinct - 1, len(line)):
      chars = set()
      for ofset in range(consec_distinct):
        chars.add(line[index-ofset])
      if len(chars) == consec_distinct:
        break
  ...
  print("The start-of-packet marker was detected after {} chars!".format(index + 1))